...
-H: gapless alignment score ratio (0.7)\n\
-I: the maximum distance between two gapless alignments (2000)\n\
\n\
...
";
  ...
  const char optionString[] =
    "hVR:u:s:f:r:q:p:a:b:A:B:c:F:x:y:z:d:e:H:I:D:E:Q:T:m:l:L:n:C:k:i:w:t:g:G:vj:";
...
#include "version.hh"
    ...
    case 'e':
      ...
      break;
    case 'H':
      unstringify( gaplessRatio, optarg );
      if( gaplessRatio < 0 ) badopt( c, optarg );
      break;
    case 'I':
